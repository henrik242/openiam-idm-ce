...
var JSON;
if (!JSON) {
	alert("there is no native JSON object. Init JSON in json2.js");
	JSON = {};
}
...
(function() {
	...
	if (typeof JSON.stringify !== 'function') {
		alert("there is no native stringify function in browser. Define it in json2.js");
...
$.postJSON = function(url, data, callback, /*errorCallback,*/ timeout) {
	if (!timeout)
		timeout = 10000000;
	return jQuery.ajax({
		'type' : 'POST',
