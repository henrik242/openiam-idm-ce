					...
					<div class="block">
			            ...
			            <form:select path="user.employeeType">
          				...
          				<p class="error"><form:errors path="user.employeeType" /></p>      		
								...
								<div class="row">
									<label for="t-11"><a href="javascript:showUserDialog('supervisorId', 'supervisorName' );">Select Supervisor</a></label>
									&nbsp;
								</div>	
								<div class="row">
       						...
       						<form:input path="cellPhone" size="10" maxlength="10"  onchange="return  validateInt(cellPhone);" cssClass="phone"/>      			
								...
								<div class="row">
									<label for="t-13">Home Phone</label>
										<form:input path="homePhoneAreaCode" size="3" maxlength="3" onchange="return  validateInt(homePhoneAreaCode);" cssClass="code" /> 
       					  	<form:input path="homePhoneNbr" size="10" maxlength="10" onchange="return  validateInt(homePhoneNbr);" cssClass="phone" />   			
								</div>								
