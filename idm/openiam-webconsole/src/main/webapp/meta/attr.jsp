					...
					<legend>TYPE ATTRIBUTES </legend>
						...
						<table class="fieldsetTable"  width="100%" >
				  		  ...
				  		  <tr>
							  	...
							  	<td valign="top">
							  		<table>
							  			...
							  			<tr>
							  				...
							  				<td class="tdlight"><form:input path="element.attributeName" size="40" maxlength="40"  />
                                                  <form:errors path="element.attributeName" cssClass="error" /></td>
							  			</tr>
							  			<tr>
							  			...
							  			<tr>
							  				...
							  				<td class="tdlight"><form:input path="element.minLen" size="5" maxlength="5"  />
                                                    <form:errors path="element.minLen" cssClass="error" /></td>
							  			</tr>
							  			<tr>
							  				<td><label for="username" class="attribute">Maximum Length</label></td>
							  				<td class="tdlight"><form:input path="element.maxLen" size="5" maxlength="5"  />
                                                    <form:errors path="element.maxLen" cssClass="error" /></td>
							  			</tr>
							  			<tr>
							  			...
							  			<tr>
							  				...
							  				<td class="tdlight"><form:input path="element.minValue" size="5" maxlength="5"  />
                                              <form:errors path="element.minValue" cssClass="error" /></td>
							  			</tr>
							  			<tr>
							  				<td><label for="username" class="attribute">Maximum Value</label></td>
							  				<td class="tdlight"><form:input path="element.maxValue" size="5" maxlength="5"  />
                                              <form:errors path="element.maxValue" cssClass="error" /></td>
							  			</tr>
							  			<tr>
						          ...
						          <tr>
						              <td><label for="username" class="attribute"><a href="metadataAttribute.cnt?menuGroup=METADATA&typeId=${metadataAttrCmd.typeId}">New</a> 			  </label></td>
