...
<%
	...
	List secondaryStatusList = (List) session
			.getAttribute("secondaryStatusList");
	pageContext
			.setAttribute("secondaryStatusList", secondaryStatusList);
...
<table width="1100pt">
	...
	<tr>
		<td><html:form action="/idman/userSearch.do?action=search">
						...
						<td>
							<fieldset class="userformSearch">
								...
								<table class="fieldsetTable" width="100%">
									...
									<tr>
										<td><label for="username" class="attribute">Last
												Name</label></td>
									...
									<tr>
										...
										<td><label for="username" class="attribute">Phone
												Nbr</label></td>
										<td class="userformInput" for="username" class="labelValue">
											<html:text property="areaCode" size="3" maxlength="3" /> <html:text
												property="phoneNumber" size="10" maxlength="10" />
										</td>

									</tr>
									<tr>
										<td><label for="username" class="attribute">Principal
												Name</label></td>
										<td colspan="3" class="userformInput" for="username"
											class="labelValue"><html:text property="principalName"
									...
									<tr>
										<td><label for="username" class="attribute">User
												Status</label></td>
										<td class="userformInput" for="username" class="labelValue">
										...
										<td><label for="username" class="attribute">Account
												Status</label></td>
										<td class="userformInput" for="username" class="labelValue">
											<html:select property="secondaryStatus">
												<html:options collection="secondaryStatusList"
													property="value" labelProperty="label" />
											</html:select>
										</td>
									</tr>
									<tr>
										<td><label for="username" class="attribute">Extended
												Attributes</label></td>
										<td class="userformInput" for="username" class="labelValue"
											colspan="3"><html:select property="attributeName">
												<html:options collection="elementList" property="value"
													labelProperty="label" />
											</html:select> <html:text property="attributeValue" size="40"
												maxlength="40" /></td>
									</tr>
									<tr>
										<td><label for="username" class="attribute">Last
												Login</label></td>
										<td class="userformInput" for="username" class="labelValue"
											colspan="3"><html:select property="operation">
