			...
			<legend>EDIT USER INFORMATION</legend>
				...
				<table class="fieldsetTable"  width="100%" >
				   ...
				   <tr>
				       ...
				       <td colspan="4" class="userformInput" for="username" class="labelValue" >${editUserCmd.user.datePasswordChanged}</td>
						
				    </tr>					
				   <tr>
				       <td colspan="2"><label for="username" class="attribute" >Last Challenge Response Change:</label></td>
				       <td class="userformInput" for="username" class="labelValue" colspan="4">${editUserCmd.user.dateChallengeRespChanged}</td>
			...
			<legend>EDIT USER CONTACT INFORMATION</legend>
				...
				<table class="fieldsetTable"  width="100%" >
			  		...
			  		<tr >
				       ...
				       <td colspan="5" class="userformInput" for="username" class="labelValue"><form:input path="email1" size="50" maxlength="320"  />
				  ...
				  <tr >
				       ...
				       <td colspan="5" class="userformInput" for="username" class="labelValue"><form:input path="email2" size="50" maxlength="320"  /></td>
				   </tr>				 
				  <tr >
