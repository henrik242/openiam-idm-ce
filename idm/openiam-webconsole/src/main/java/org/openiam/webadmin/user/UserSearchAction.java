...
public class UserSearchAction extends DispatchActionSupport {
    ...
    static protected ResourceBundle resb = ResourceBundle.getBundle("datasource");
	...
	public ActionForward search(ActionMapping mapping, ActionForm form,
		...
		try {
            ...
            String fetchSize  = resb.getString("fetch.size");
            int iFetchSize = Integer.parseInt(fetchSize);
			...
			if (userList != null) {
                ...
                if (userList.size() >= iFetchSize) {
                    request.setAttribute("searchmsg","Max records displayed. Additional records may exist.  Please refine search criteria ");
                }
			}
