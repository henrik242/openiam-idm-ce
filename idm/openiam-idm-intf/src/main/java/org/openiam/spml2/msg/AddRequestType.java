...
/**
 * <p>
 * Java class for AddRequestType complex type.
 * 
 * <p>
...
@XmlType(name = "AddRequestType", propOrder = { "psoID", "containerID", "data",
		"capabilityData", "targetID", "returnData" })
public class AddRequestType extends RequestType {
	...
	protected List<CapabilityDataType> capabilityData = new ArrayList<CapabilityDataType>(
			0);
	@XmlAttribute
	...
	public AddRequestType(String requestId, ExecutionModeType executionMode,
			PSOIdentifierType type, PSOIdentifierType containerID,
			ExtensibleType data, CapabilityDataType[] capabilityData,
			String targetId, ReturnDataType returnData) {
	 ...
	 * 
	 * @return possible object is {@link ExtensibleType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link ExtensibleType }
	 * 
	 */
	 ...
	 * <CODE>set</CODE> method for the capabilityData property.
	 * 
	 * <p>
