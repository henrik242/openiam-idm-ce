...
insert into MENU (menu_id, menu_group, menu_name,menu_desc,url,LANGUAGE_CD, DISPLAY_ORDER) values('USER_CREATE_LIKE','IDMAN','Create Like','Create Like','createLike.cnt', 'en',4);
...
INSERT INTO PERMISSIONS(MENU_ID,ROLE_ID,SERVICE_ID) VALUES('USER_CREATE_LIKE','SUPER_SEC_ADMIN','IDM');
