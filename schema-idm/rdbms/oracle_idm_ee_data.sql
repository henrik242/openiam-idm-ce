...
INSERT INTO USER_ROLE (USER_ROLE_ID, SERVICE_ID, ROLE_ID, USER_ID, STATUS) VALUES('201','USR_SEC_DOMAIN','HELPDESK','3001','ACTIVE');
...
insert into PROVISION_CONNECTOR(CONNECTOR_ID, NAME, METADATA_TYPE_ID, SERVICE_URL,SERVICE_NAMESPACE, SERVICE_PORT) VALUES ('61','Application Tables CONNECTOR', 'DB_Connector','localhost/ServiceHost/ApplicationTablesConnector','http://www.openiam.org/service/connector', 'NA' );
